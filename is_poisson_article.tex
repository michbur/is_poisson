...
According to the MIQUE Guidelines for Digital PCR, $k$ is number of positive partitions and $n$ is a total number of partitions. To perform the permutation test, we firstly compute $\hat\lambda$ for data vector. Next, the density of
